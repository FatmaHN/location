...
class FormMaisonComplet extends StatefulWidget {
  // ignore: use_key_in_widget_constructors
  FormMaisonComplet(User, this._file);
  User user = _firebaseAuth.currentUser!;
  File _file;
  @override
  State<FormMaisonComplet> createState() => _FormMaisonCompletState();
}

class _FormMaisonCompletState extends State<FormMaisonComplet> {
  TextEditingController typeLocation =
      TextEditingController(text: "Maison complète");
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Maison complète '),
      ),
      body: StreamBuilder(
