...
class FormFoyerPrive extends StatefulWidget {
  // ignore: use_key_in_widget_constructors
  FormFoyerPrive(User, this._file);
  User user = _firebaseAuth.currentUser!;
  File _file;
  @override
  State<FormFoyerPrive> createState() => _FormFoyerPriveState();
}

class _FormFoyerPriveState extends State<FormFoyerPrive> {
  TextEditingController typeLocation =
      TextEditingController(text: "Foyer Privé");
