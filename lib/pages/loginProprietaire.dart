...
class loginProprietaireScreen extends StatefulWidget {
  ...
  @override
  State<loginProprietaireScreen> createState() =>
      _loginProprietaireScreenState();
}
                          ...
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: TextFormField(
                                ...
                                validator: (value) {
                                  if (value!.isEmpty) {
                                    return 'Le champs de mot de passe est vide ';
                                  }
                              ...
                              child: CupertinoButton(
                                  ...
                                  onPressed: () async {
                                    if (loginKey.currentState!.validate()) {
                                      dynamic credentials =
                                          await _authServiceEtudiant.loginUser(
                                              emailC.text.trim(),
                                              passwordC.text.trim());
                                      if (credentials == null) {
                                        const snackBar = SnackBar(
                                            content: Text(
                                                "Email ou mot de passe n'est pas valide"),
